...
% cases =  {'case9_DCOPF';'case30_DCOPF';'case39_DCOPF';'case57_DCOPF';'case118_DCOPF';'case162_DCOPF';'case300_DCOPF'};
...
for c = 1:nr_cases
    ...
    dataset_folder = strcat(pwd,'/Data_Sets/case',num2str(nb),'_DCOPF/');
