...
% the test cases are from PGLIB-OPF networks
% available at https://github.com/power-grid-lib/pglib-opf
% Add them to matpower folder

cases = {'pglib_opf_case39_epri';'pglib_opf_case118_ieee'; 'pglib_opf_case162_ieee_dtc'};
...
for c = 1:nr_cases
    ...
    % save test cases
    savecase(strcat('./Test_Network(Copy to Matpower)/Modified Network/case',num2str(nb),'_DCOPF'),mpc);
